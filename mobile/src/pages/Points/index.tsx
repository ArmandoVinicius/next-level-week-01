    ...
    return (
        <>
            <View style={S.container}>
                ...
                <Text style={S.description}>Encontre no mapa um ponto de coleta.</Text>
                        ...
                        {points.map(point => (
                          ...
                          >
                            <View style={S.mapMarkerContainer}>
                                <Image style={S.mapMarkerImage} source={{ uri: point.image_url }} />
                                <Text style={S.mapMarkerTitle}>{point.name}</Text>
                            </View>
                          </Marker>
                        ))}
                      </MapView>
                ...
                >
                    {items.map(item => (
                      <TouchableOpacity 
                        ...
                        style={[
                          S.item,
                          selectedItems.includes(item.id) ? S.selectedItem : {}
                        ]} 
